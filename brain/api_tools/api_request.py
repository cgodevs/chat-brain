...
def consultar_por_tipo(
    ...
    try:
        ...
        if filtro:
            return filter_results(response_json, filtro)
...
def download_tipo(
    ...
    """
    Faz o download dos assuntos, classes, movimentos ou documentos processuais no Sistema de Gestão de Tabelas Unificadas.
...
# todos_assuntos = download_tipo("assuntos")

# Download de um assunto específico
